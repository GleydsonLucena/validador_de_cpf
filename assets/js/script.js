...
class Validator {
    ...
    valid() {
        if (typeof this.cpfClean === undefined) return alert('Digite um CPF válido!');
        if (this.cpfClean.length !== 11) return alert('Digite um CPF válido!');
        if (this.isSequence()) return alert('Digite um CPF válido!');
